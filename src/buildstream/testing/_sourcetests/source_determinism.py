...
from .base import BaseBstGenericSourceTests
...
class SourceDeterminismBstStandardSourceTests(BaseBstGenericSourceTests):
    @pytest.mark.skipif(not HAVE_SANDBOX, reason="Only available with a functioning sandbox")
    def test_deterministic_source_umask(self, cli, tmpdir, datafiles):
        # FIXME: this should be done on the implemention on the ostree side
